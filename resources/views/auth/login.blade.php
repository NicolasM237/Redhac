                ...
                <div class="col-md-6">
                    <div class="authentication-content"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/images/redhac.png') }}" alt="Logo Redhac" width="150" height="120"
                                style="border-radius: 10%;">
                            <h1 class="mb-3 text-white">PLATEFORME REDHAC</h1>
                            <p class="mb-0">Panel d'administration de l'application des violences basées sur le genre</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form" >
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary btn-block" style="background-color: #00346b; border: none; width: 100%; padding: 10px;">
                                                SE CONNECTER
                                            </button>
                                        </div>
                                    </form>
                        ...
                        <small class="copyright" style="display: block; text-align:center; margin-top: 20px;">
                            <p>Copyright © Designed &amp; Developed by <a href="/login">Univers Solutions</a> 2026</p>
                        </small>
                    </div>
                </div>
            </div>
